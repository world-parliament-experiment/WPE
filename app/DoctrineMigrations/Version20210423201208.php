 ...
 */
class Version20210423201208 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_E115DEFE8CDE5729 ON initiative (type)');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('DROP INDEX UNIQ_E115DEFE8CDE5729');
