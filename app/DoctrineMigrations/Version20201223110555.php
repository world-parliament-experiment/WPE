 ...
 */
class Version20201223110555 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER SEQUENCE ext_log_entries_id_seq INCREMENT BY 29');
        $this->addSql('ALTER SEQUENCE initiative_id_seq INCREMENT BY 0');
