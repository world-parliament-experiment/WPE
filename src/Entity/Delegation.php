...
class Delegation
{
     ...
     * @var User $user
     *
     * @ORM\ManyToOne(targetEntity="App\Entity\User", inversedBy="delegations")
     ...
     * @var User $truster
     *
     * @ORM\ManyToOne(targetEntity="App\Entity\User", inversedBy="trustees")
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\Initiative", inversedBy="delegations")
     * @ORM\JoinColumn(nullable=true)
     */
