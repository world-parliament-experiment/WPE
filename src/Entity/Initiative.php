...
class Initiative
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Voting", mappedBy="initiative")
     */
    protected $votings;

    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Delegation", mappedBy="initiative")
     */
    protected $delegations;

    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Favourite", mappedBy="initiative")
     */
