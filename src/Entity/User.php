...
class User implements UserInterface
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Delegation", mappedBy="user")
     */
    protected $delegations;

    /**
     * @ORM\OneToMany(targetEntity="App\Entity\UserImage", mappedBy="user")
     */
    protected $images;

    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Delegation", mappedBy="truster")
     */
    protected $trustees;
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Favourite", mappedBy="friend",cascade={"persist"})
     */
    protected $friends;
