...
class Voting
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\Initiative", inversedBy="votings")
     * @ORM\JoinColumn(nullable=false)
     */
    protected $initiative;

    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Vote", mappedBy="voting")
     */
    protected $votes;
    ...
    public function __construct()
    {
        ...
        $this->quorum = VotingEnum::QUORUM;
        $this->consensus = VotingEnum::CONSENSUS;
    }
