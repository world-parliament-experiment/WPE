...
class WidgetExtension extends AbstractExtension
{
    ...
    public function getTests()
    {
        return array(
            ...
            new \Twig_SimpleTest('UnknownDate', [$this, 'isUnknownDate']),
        );
    }
    ...
    public function panel_start(\Twig_Environment $environment, $title='', $options=array())
    {
        return $environment->render('Widget/panel_start.html.twig', array("title" => $title, "options" => $options));
    }

    public function panel_end(\Twig_Environment $environment)
    {
