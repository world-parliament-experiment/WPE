...
use App\Form\InitiativeUserForm;
use DateTime;
...
//        $response->headers->set('Content-Type', $image->getContentType());
    ...
    public function delegateAction(Request $request)
    {
        ...
        $editForm = $this->createForm('App\Form\DelegationForm', $delegation, [
        ...
        foreach ($categories as $category) {
            ...
            $categoryForm = $this->createForm('App\Form\DelegationForm', $delegation, [
    ...
    public function editAction(Request $request, int $id)
    {
        ...
        $editForm = $this->createForm('App\Form\InitiativeUserForm', $initiative);
        $editForm->handleRequest($request);
    ...
    public function avatarAction(int $id)
    {
        ...
        $path = $this->kernel->getProjectDir() . '/public/assets/img/avatar/' . $image->getPath();
